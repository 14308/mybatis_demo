    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new GlobalConfig()
                        ...
                        .setOutputDir("D://mybatis_demo")//输出目录
                ...
                new StrategyConfig()
                        ...
                        // .setInclude(new String[] { "user" }) // 需要生成的表
                         ...
                         .setExclude(new String[]{"DATABASECHANGELOG","DATABASECHANGELOGLOCK"}) // 排除生成的表
...
//                        .setSuperEntityColumns(new String[]{"id"})
                ...
                new InjectionConfig() {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        ...
                        return "src/main/resource/template/" + tableInfo.getEntityName() + ".xml";
